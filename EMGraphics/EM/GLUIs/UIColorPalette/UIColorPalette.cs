    ...
    public partial class UIColorPalette : UIRenderer
    {
            ...
            : base(anchor, margin, size, -100, 100)
        {
            ...
            //}
            {
                ...
                var font = new Font("新宋体", 22);
                FontTexture texture = font.GetFontBitmap("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890.:,;'\"(!?)+-*/=_{}[]@~#\\<>|^%$£& ").GetFontTexture();

                var headLine = new UIText(AnchorStyles.Left | AnchorStyles.Top,
                    new Padding(3, 3, 3, 3), new Size(170, 15), -100, 100);
                headLine.Text = "Surface current[mA/m]";
                headLine.TextColor = Color.Black;
                //headLine.StateList.Add(new ClearColorState(Color.Green));
