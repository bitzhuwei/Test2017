namespace EMGraphics
{
    ...
    /// </summary>
    public partial class CenterAxisLabelRenderer : Renderer
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static CenterAxisLabelRenderer Create(int maxCharCount = 64, int labelHeight = 32, IFontTexture fontTexture = null)
        {
            ...
            var renderer = new CenterAxisLabelRenderer(model, provider, map);
        ...
        private CenterAxisLabelRenderer(IBufferable model, IShaderProgramProvider shaderProgramProvider,
