namespace EMGraphics
{
    ...
    /// </summary>
    public partial class AxisLabelRenderer : Renderer
    {
        /// <summary>
        ...
        public static AxisLabelRenderer Create(int maxCharCount = 64, int labelHeight = 20, IFontTexture fontTexture = null)
        {
            ...
            var renderer = new AxisLabelRenderer(model, provider, map);
        ...
        private AxisLabelRenderer(IBufferable model, IShaderProgramProvider shaderProgramProvider,
